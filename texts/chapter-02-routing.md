...
# and routes the original input ('request') to the corresponding handler. delegation_branch = RunnableBranch(    
...
booking_agent = Agent(
    ...
    description=(
        "A specialized agent that handles all flight "
...
info_agent = Agent(
    ...
    model="gemini-2.0-flash",
    description=(
        "A specialized agent that provides general information "
...
<figure>
<img src="../img/fig,2.1.router_pattern_using_a llm_as_a_router.png" alt="Router pattern, using an LLM as a Router" width="500" height="300">
<figcaption>Fig.1: Router pattern, using an LLM as a Router</figcaption>
</figure>
